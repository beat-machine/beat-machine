...
class TestPeriodicEffects(unittest.TestCase):
    def setUp(self):
        self.dummy_song = [[1] * 4, [2] * 4, [3] * 4, [4] * 4]
    ...
    def test_remove_every_nth(self):
        ...
        self.assertEqual([[1] * 4, [3] * 4], list(remove_effect(self.dummy_song)))
    ...
    def test_reverse_every_nth(self):
        ...
        self.assertEqual(
            [snare_drum, reversed_snare_drum, snare_drum, reversed_snare_drum],
